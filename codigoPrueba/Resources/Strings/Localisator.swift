...
class Localisator {
    ...
    fileprivate var availableLanguagesArray = ["Spanish_es", "English_en", "Catalan_ca"]
    ...
    // MARK: - Init method
    init() {
        currentLanguage = userDefaults.object(forKey: "kSaveLanguageDefaultKey") as? String ?? "Spanish_es"
